...
class UsuarioCliente 
{
	...
	public function login(){
		...
		$sql   = "SELECT Id,Nro_nomina,Usuario,IdGrupo_sistema as idgrupo,Pass,Nombre FROM USUARIO_CLIENTE WHERE Usuario = '$usuario' AND IdGrupo_sistema IN(42,220,227,157,193,150,226,237,32,16) AND Estado = 1";
